            ...
            [
                SymmetricChainCOMPotential(
                    parameters={
                        "guidance_interval": 4,
                        "guidance_weight": (
                            0.5 if steering_args["contact_guidance_update"] else 0.0
                        ),
                ...
                ConnectionsPotential(
                    parameters={
                        "guidance_interval": 1,
                        "guidance_weight": (
                            0.15 if steering_args["contact_guidance_update"] else 0.0
                        ),
                ...
                PoseBustersPotential(
                    parameters={
                        "guidance_interval": 1,
                        "guidance_weight": (
                            0.01 if steering_args["contact_guidance_update"] else 0.0
                        ),
                ...
                StereoBondPotential(
                    parameters={
                        "guidance_interval": 1,
                        "guidance_weight": (
                            0.05 if steering_args["contact_guidance_update"] else 0.0
                        ),
                        "resampling_weight": 1.0,
                        "buffer": 0.52360,
                    }
